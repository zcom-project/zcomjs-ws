# zcom websocket interface (zcomjs-ws)

Pure JavaScript zcom websocket library for node.js and browsers. Can be used to easily connect to and obtain data from the zcom blockchain via public apis or local nodes.

Credit for the original implementation goes to [jcalfeee](https://github.com/jcalfee).

[![npm version](https://img.shields.io/npm/v/zcomjs-ws.svg?style=flat-square)](https://www.npmjs.com/package/zcomjs-ws)
[![npm downloads](https://img.shields.io/npm/dm/zcomjs-ws.svg?style=flat-square)](https://www.npmjs.com/package/zcomjs-ws)
...
```
<script type="text/javascript" src="https://cdn.rawgit.com/zcom/zcomjs-ws/build/zcomjs-ws.js" />
```

A variable zcom_ws will be available in window.

For use in a webpack/browserify context, see the example below for how to open a websocket connection to the Openledger API and subscribe to any object updates:

```
var {Apis} = require("zcomjs-ws");
Apis.instance("wss://zcom.openledger.info/ws", true).init_promise.then((res) => {
...
This is a non-exhaustive list of endpoints available from the witness_node executable, which provides the API server of zcom.

## database_api
https://github.com/zcom/zcom-core/blob/master/libraries/app/database_api.cpp
